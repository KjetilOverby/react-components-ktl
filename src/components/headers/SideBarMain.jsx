            ...
            const SideBar = () => {
              ...
              return (
                <>{isMobile && (<div onClick={openSidebarHandler} className="menu-icon-container"><IoMenuSharp style={{ fontSize: "1.5rem" }} /></div>)}{openSidebar && isMobile && (
                    ...
                    ></div>
                  )}<div className={\`container $\{container}\`}><Link href="/"><p className={\`logo\`}>☯︎</p></Link><input className="input" placeholder="Search" /><h4 className="section-header">Header</h4><Link href="/about"><p className={\`section-tab $\{activate}\`}>About</p></Link><Link href="/"><p className={\`section-tab $\{activate2}\`}>Work</p></Link><Link href="/layout/columns2layout"><p className={\`section-tab $\{activate3}\`}>News</p></Link><Link href="/"><p className={\`section-tab $\{activate4}\`}>Testing</p></Link><h4 className="section-header">Build</h4><Link href="/"><p className={\`section-tab $\{activate5}\`}>House</p></Link><Link href="/"><p className={\`section-tab $\{activateHeader}\`}>Mall</p></Link>
